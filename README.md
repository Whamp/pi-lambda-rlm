...
Most setup failures should be diagnosed through `/lambda-rlm-doctor`. Tool validation failures also point there when the Lambda-RLM Tool cannot run because setup is incomplete.
